...
export const ArrowBack = ({ size = 25, color }: IconProps) => {
  return (
    <svg
...
export const ArrowForward = ({ size = 25, color }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const DoubleArrowForward = ({ size = 25, color }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const DoubleArrowBack = ({ size = 25, color }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export const Close = ({ size = 25, color }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
